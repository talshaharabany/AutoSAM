...
class HarDNet(nn.Module):
    def __init__(self, depth_wise=False, arch=85, pretrained=True, weight_path='', out=1, args=None):
        ...
        if pretrained:
            ...
            if int(args['outlayer']) == 1:
                if int(args['order']) == 39:
                    self.features = 96
                    self.base = self.base[0:5]
                if int(args['order']) == 68:
                    self.features = 128
                    self.base = self.base[0:5]
                if int(args['order']) == 85:
                    self.features = 192
                    self.base = self.base[0:5]
            elif int(args['outlayer']) == 2:
                if int(args['order']) == 39:
                    self.features = 320
                    self.base = self.base[0:8]
                if int(args['order']) == 68:
                    self.features = 320
                    self.base = self.base[0:10]
                if int(args['order']) == 85:
                    self.features = 320
                    self.base = self.base[0:10]
            elif int(args['outlayer']) == 3:
                if int(args['order']) == 39:
                    self.features = 640
                    self.base = self.base[0:11]
                if int(args['order']) == 68:
                    self.features = 640
                    self.base = self.base[0:13]
                if int(args['order']) == 85:
                    self.features = 720
                    self.base = self.base[0:15]
            elif int(args['outlayer']) == 4:
                if int(args['order']) == 39:
                    self.features = 1024
